...
namespace vk::images
{
    ...
    void BMP::ENCODE(const std::string& shifr) 
    {
        ...
        for (int i = 0; i < shifr.length(); i++) 
        {
            if (shifr[i] == 'K')
            {
                ...
                for (int f = 540; f <= 700; f++)
                    for (int s = 960; s > 930; s--)
                    {
                        inclass_pixels[f][s].b++;
                    }
                ...
                {
                    s1 = i;
                    for (int f = 610; f > 540; f--)
                    {
                        s1++;
                        inclass_pixels[f][s1].b++;
                    }
                }
                ...
                std::cout << "It`s impossible to ENcode this letter" << std::endl;
        }
